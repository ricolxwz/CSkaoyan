...
\subsection{组合逻辑\texttt{CPU}基础}
\begin{figure}[H]
\centering
\includegraphics[scale=.3]{img/figure24.pdf}
\end{figure}
\subsubsection{\texttt{lw}操作}
